...
public class JSON {
    ...
    public static Object fromJSON(String json) throws FSMException, EmptyJSONException, MalformedJSONException, InvalidJSONTypeException, JSONNumberFormatException {
        Object object;
